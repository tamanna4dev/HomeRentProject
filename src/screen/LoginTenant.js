...
const LoginTenant = ({ navigation }) => {
  ...
  return (
    <ScrollView style={{  flex: 1,
      ...
      <Text style={styles.title}>RENT VENT</Text>
      <Text style={styles.subtitle}>Welcome! Let's dive in intro account.</Text>

      <Text style={styles.loginAs}>Login As Tenant</Text>
      ...
      {isOtpSent && (
        <>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('MainApp')} style={styles.submitBtn}>
